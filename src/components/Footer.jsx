...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-pylon-dark text-white">
      {/* Main Footer */}
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold font-heading">ELITE<span className="text-pylon-blue">PAISAA</span></span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.loans.map((link, idx) => (
                <li key={idx}>
                  <a href={link.href} className="text-gray-400 hover:text-pylon-blue transition">
                    {link.name}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              ...
              <p className="text-gray-400 text-sm">Get the latest updates on loans and financial tips</p>
            </div>
            <div className="flex gap-2 w-full md:w-auto">
              <input 
                type="email" 
                placeholder="Enter your email"
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:outline-none focus:border-pylon-blue text-white w-full md:w-64"
              />
              <button className="bg-pylon-blue px-6 py-3 rounded-lg font-medium hover:bg-blue-600 transition whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              {currentYear} ElitePaisaa. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              <a href="#" className="text-gray-400 hover:text-pylon-blue transition">
