...
const StatsCounter = () => {
  ...
  return (
    <section ref={ref} className="py-15 bg-pylon-blue relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, idx) => (
            ...
            >
              <div className="w-16 h-16 bg-white/10 rounded-xl flex items-center justify-center text-white mx-auto mb-4">
                {stat.icon}
              </div>
