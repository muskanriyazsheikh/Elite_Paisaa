            ...
            {displayServices.map((service, idx) => (
              <SwiperSlide key={idx}>
                ...
                >
                  ...
                  {/* CTA */}
                  <button onClick={() => navigate('/apply')} className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2">
                    Apply Now
