              ...
              <SwiperSlide key={idx}>
                ...
                >
                  ...
                  <div className="space-y-2">
                    <button 
                      onClick={() => navigate(`/loan-documents/${getLoanTypeKey(service.title)}`)} 
                      className="w-full py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2"
                    >
